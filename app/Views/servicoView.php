...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex align-items-center mb-2">
            <h1>Serviços</h1>
            <a href="<?php echo base_url('servicos/create'); ?>" class="btn btn-success ms-3">Novo Serviço</a>
        </div>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                <?php foreach ($servicos as $servico): ?>
                    <tr>
                        ...
                        <td class="align-middle">
                            <?php echo $servico['valorServico'] ?>
                        </td>
                        <td class="align-middle">
                            <a class="" href="<?php echo base_url('servicos/edit/' . $servico['idServico']); ?>">
                                <i class="bi bi-pencil-square" style="font-size: 1.5rem;color:black;"></i>
                            </a>
                            <a href="<?php echo base_url('servicos/delete/' . $servico['idServico']) ?>" class=""
